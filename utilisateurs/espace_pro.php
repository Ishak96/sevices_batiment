    ...
    $row = $query->fetch();
        ...
        if (isset($_POST['upload'])) {
            ...
            if (isset($_FILES['file'])) {
                ...
                $file_destination = "../admin/ressources/photo_profile_util/util/".$file_name_new;
                $no_util = $row[5];
            ...
            if (isset($_POST['repondre'])) {
                $db->query("UPDATE contacter SET valider = TRUE
                        WHERE no_util_cli = '".$_POST['no_util']."'");
            }
                ...
                <div id="main">
                    <div id="div_info_perso">                             
                        <?php
                            ...
                            $photo_profil = "<input type='image' src='../images/default_prof.jpeg' alt='photo_profil' height='150' width='150'/>";

                            if (isset($_POST['upload']) || $row[6]!=NULL){
                                $photo_profil = "<input type='image' src='".$row[6]."' alt='photo_profil'
                                    height='150' width='150'/>";
                            }

                            $upload_fields = '<p id="upload_fields" style="display: none;">
                            <label for="file" class="input-lable" ><img src="../images/img.png" height="30" alt="upl_img" /></label>
                        ...
                        <div id="mes_actions" style="margin-left: 20%;">
                            ...
                            <?php
                                echo $db->liste_RDV_pro($row['no_util']);
                            ?>
                            <h3>Mes locations</h3>
                            <?php
